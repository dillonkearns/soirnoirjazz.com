            ...
            Nothing ->
                [ Html.div
                    ...
                    [ Html.h1
                        ...
                        , Attr.style "font-family" "Times New Roman, serif"
                        ]
...
viewLineup zone event maybeBand musicians =
    Html.div
        ...
        [ Html.div
            ...
            [ Html.h1
                [ Attr.class "text-5xl font-bold text-center text-yellow-500 mb-8"
                , Attr.style "font-family" "Times New Roman, serif"
                , Attr.style "text-shadow" "2px 2px 4px rgba(0, 0, 0, 0.8)"
                ]
                [ Html.text "Tonight's Lineup" ]
            , Html.p
                [ Attr.class "text-center text-gray-300 mb-2 text-xl font-medium"
                ]
                [ Html.text event.name ]
            , Html.p
                [ Attr.class "text-center text-gray-400 mb-16 text-lg"
                ]
            ...
            , case maybeBand of
                Just band ->
                    Html.div []
                        [ viewBand band
                        , Html.h2
                            [ Attr.class "text-3xl font-bold text-yellow-500 mt-16 mb-8"
                            , Attr.style "font-family" "Times New Roman, serif"
                            ]
                ...
                Nothing ->
                    Html.div []
                        [ Html.h2
                            [ Attr.class "text-3xl font-bold text-yellow-500 mb-8"
                            , Attr.style "font-family" "Times New Roman, serif"
                            ]
...
viewBand band =
    Html.div
        [ Attr.class "bg-gray-900 rounded-lg p-8 shadow-xl border border-yellow-500/30"
        ]
        [ Html.div
            ...
            , Html.div []
                [ Html.h3
                    [ Attr.class "text-3xl font-bold text-yellow-500 mb-1"
                    , Attr.style "font-family" "Times New Roman, serif"
                    ]
                    [ Html.text band.name ]
                , Html.p
    ...
    Html.div
        ...
        [ Html.div
            ...
            , Html.div [ Attr.class "" ]
                ...
                , Html.p
                    [ Attr.class "text-yellow-500 text-lg mb-3"
                    ]
...
viewSocialLink musicianName link =
    Html.a
        ...
        , Attr.class "w-10 h-10 rounded-lg bg-yellow-500 hover:bg-yellow-400 flex items-center justify-center text-black transition-colors"
        ]
        [ Html.span
            [ Attr.class "sr-only"
            ]
